...
const RELEVANT_STYLES = [
  ...
  'line-height', 'font-variant', 'text-transform', 'letter-spacing', 'border', 'box-sizing', 'display',
];
...
export function expandableTextareaFromNodes(shadowBox, textarea, maxLines){
  ...
  const lines = (initial, currentHeight) => parseInt(((currentHeight - initial) / lineHeight()) + 1);
