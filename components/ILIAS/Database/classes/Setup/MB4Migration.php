...
class MB4Migration implements Migration
{
    ...
    private function fixBrokenTables(): void
    {
        if ($this->db->tableColumnExists('il_resource_flavour', 'variant')) {
            $this->db->modifyTableColumn('il_resource_flavour', 'variant', ['type' => 'text', 'notnull' => false, 'length' => 100]);
        }
    }
}
