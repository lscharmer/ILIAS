...
class URITest extends TestCase
{
     ...
     */
    public function test_init(): \ILIAS\Refinery\Data\URI
    {
        return new ILIAS\Refinery\Data\URI(self::URI_COMPLETE);
    }
    ...
    {
        $uri = new ILIAS\Refinery\Data\URI(self::URI_COMPLETE_IPV4);
    ...
    {
        $uri = new ILIAS\Refinery\Data\URI('http://' . $host);
    ...
    {
        $uri = new ILIAS\Refinery\Data\URI(self::URI_COMPLETE_LOCALHOST);
        $this->assertEquals('g+it', $uri->getSchema());
    ...
    public function test_base_uri_idempotent($uri): void
    {
        ...
        $uri = new ILIAS\Refinery\Data\URI($base_uri);
    ...
    {
        $uri = new ILIAS\Refinery\Data\URI(self::URI_NO_PATH_1);
        $this->assertEquals('g-it', $uri->getSchema());
        ...
        $uri = new ILIAS\Refinery\Data\URI(self::URI_NO_PATH_2);
        $this->assertEquals('g.it', $uri->getSchema());
    ...
    {
        $uri = new ILIAS\Refinery\Data\URI(self::URI_NO_QUERY_1);
        ...
        $uri = new ILIAS\Refinery\Data\URI(self::URI_NO_QUERY_2);
        $this->assertEquals('git', $uri->getSchema());
        $this->assertEquals('github.com:8080', $uri->getAuthority());
        $this->assertEquals('github.com', $uri->getHost());
        $this->assertEquals('8080', $uri->getPort());
    ...
    {
        $uri = new ILIAS\Refinery\Data\URI(self::URI_AUTHORITY_AND_QUERY_1);
        $this->assertEquals('git', $uri->getSchema());
        ...
        $uri = new ILIAS\Refinery\Data\URI(self::URI_AUTHORITY_AND_QUERY_2);
        $this->assertEquals('git', $uri->getSchema());
        $this->assertEquals('github.com', $uri->getAuthority());
        $this->assertEquals('github.com', $uri->getHost());
        $this->assertNull($uri->getPort());
    ...
    {
        $uri = new ILIAS\Refinery\Data\URI(self::URI_AUTHORITY_AND_FRAGMENT);
        $this->assertEquals('git', $uri->getSchema());
        $this->assertEquals('github.com:8080', $uri->getAuthority());
        $this->assertEquals('github.com', $uri->getHost());
        $this->assertEquals('8080', $uri->getPort());
    ...
    {
        $uri = new ILIAS\Refinery\Data\URI(self::URI_AUTHORITY_PATH_FRAGMENT);
        $this->assertEquals('git', $uri->getSchema());
    ...
    {
        $uri = new ILIAS\Refinery\Data\URI(self::URI_PATH);
        $this->assertEquals('git', $uri->getSchema());
        $this->assertEquals('git$,;hub.com:8080', $uri->getAuthority());
        $this->assertEquals('git$,;hub.com', $uri->getHost());
        $this->assertEquals('8080', $uri->getPort());
    ...
    {
        $uri = new ILIAS\Refinery\Data\URI(self::URI_AUTHORITY_ONLY);
        $this->assertEquals('git', $uri->getSchema());
    ...
    public function test_no_schema(): void
    {
        ...
        new ILIAS\Refinery\Data\URI(self::URI_NO_SCHEMA);
    }
    ...
    {
        $this->expectException(TypeError::class);
        new ILIAS\Refinery\Data\URI(self::URI_NO_AUTHORITY);
    }
    ...
    {
        $this->expectException(TypeError::class);
        new ILIAS\Refinery\Data\URI(self::URI_WRONG_SCHEMA);
    }
    ...
    public function test_wrong_authority_in_schema_1(): void
    {
        ...
        new ILIAS\Refinery\Data\URI(self::URI_WRONG_AUTHORITY_1);
    }
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        new ILIAS\Refinery\Data\URI(self::URI_WRONG_AUTHORITY_2);
    }
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        new ILIAS\Refinery\Data\URI(self::URI_INVALID);
    }
    ...
    {
        $uri = new ILIAS\Refinery\Data\URI(self::URI_REALPCTENC);
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        new ILIAS\Refinery\Data\URI(self::URI_FAKEPCENC);
    }
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        new ILIAS\Refinery\Data\URI(self::URI_HOST_ALPHADIG_START_1);
    }
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        new ILIAS\Refinery\Data\URI(self::URI_HOST_ALPHADIG_START_2);
    }
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        new ILIAS\Refinery\Data\URI(self::URI_HOST_ALPHADIG_START_3);
    }
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        new ILIAS\Refinery\Data\URI(self::URI_HOST_ALPHADIG_START_4);
    }
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        new ILIAS\Refinery\Data\URI(self::URI_HOST_ALPHADIG_START_5);
    }
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $uri = new ILIAS\Refinery\Data\URI(self::URI_COMPLETE);
        $uri->withSchema('');
    }
    ...
    public function testGetParameters(): ILIAS\Refinery\Data\URI
    {
        $url = self::URI_BASE . '?' . http_build_query(self::PARAMS);
        $uri = new ILIAS\Refinery\Data\URI($url);
        $this->assertEquals(
            self::PARAMS,
            $uri->getParameters()
        );
     ...
     */
    public function testGetParameter(ILIAS\Refinery\Data\URI $uri): void
    {
     ...
     * @depends testGetParameters
     */
    public function testWithParameters(ILIAS\Refinery\Data\URI $uri): ILIAS\Refinery\Data\URI
    {
        $params = ['x' => 1, 'y' => 2];
     ...
     */
    public function testSubstituteParameter(ILIAS\Refinery\Data\URI $uri): void
    {
     ...
     * @depends testWithParameters
     */
    public function testAppendParameter(ILIAS\Refinery\Data\URI $uri): void
    {
        $params = [
            'x' => 1, 'y' => 2,
            'z' => 5
     ...
     * @depends testGetParameters
     */
    public function testWithArrayParameters(ILIAS\Refinery\Data\URI $uri): void
    {
